...
bool ConfigDll::Loading() {
	...
	Config_CreateUser =			(Config_CreateUser_)				GetProcAddress(dll, "Config_CreateUser");
	Config_CreateComputer =		(Config_CreateComputer_)			GetProcAddress(dll, "Config_CreateComputer");
	Config_ReadUser =			(Config_ReadUser_)					GetProcAddress(dll, "Config_ReadUser");
	Config_ReadComputer =		(Config_ReadComputer_)				GetProcAddress(dll, "Config_ReadComputer");
	Config_SetComputer =		(Config_SetComputer_)				GetProcAddress(dll, "Config_SetComputer");

...
export default {
  ...
  methods: {
    ...
    f_app: function(w) {
      ...
      /* SystemMenu */
      if (typeof obj_app.SystemMenu == "undefined") {
        obj_app.SystemMenu = {};
      }
      obj_app.SystemMenu.Exit = () => {
        if (
          typeof obj_app_ == "object" &&
          typeof obj_app_.SystemMenu == "object" &&
          typeof obj_app_.SystemMenu.Exit == "function"
        ) {
          return obj_app_.SystemMenu.Exit();
        }
      };
      obj_app.SystemMenu.Mini = () => {
        if (
          typeof obj_app_ == "object" &&
          typeof obj_app_.SystemMenu == "object" &&
          typeof obj_app_.SystemMenu.Mini == "function"
        ) {
      ...
      /* Login */
      if (typeof obj_app.Login == "undefined") {
        obj_app.Login = {};
      }
      obj_app.Login.Login = function(w) {
        if (
          typeof obj_app_ == "object" &&
          typeof obj_app_.Login == "object" &&
          typeof obj_app_.Login.Login == "function"
        ) {
      ...
      /* Main */
      if (typeof obj_app.Main == "undefined") {
        obj_app.Main = {};
      }

      /* Main.All */
      if (typeof obj_app.Main.All == "undefined") {
        obj_app.Main.All = {};
      }
      obj_app.Main.All.Get_w = function() {
        if (
          ...
          typeof obj_app_.Main.All == "object" &&
          typeof obj_app_.Main.All.Get_w == "function"
        ) {
      ...
      obj_app.Main.All.Set_Language = function(name) {
        if (
          ...
          typeof obj_app_.Main == "object" &&
          typeof obj_app_.Main.All == "object" &&
          typeof obj_app_.Main.All.Set_Language == "function"
        ) {
      ...
      /* Main.Setting */
      if (typeof obj_app.Main.Setting == "undefined") {
        obj_app.Main.Setting = {};
      }
      obj_app.Main.Setting.Get_ComputerName = function() {
        if (
          typeof obj_app_ == "object" &&
          typeof obj_app_.Main == "object" &&
          typeof obj_app_.Main.Setting == "object" &&
          typeof obj_app_.Main.Setting.Get_ComputerName == "function"
        ) {
      ...
      obj_app.Main.Setting.Set_ComputerName = function(name) {
        if (
          ...
          typeof obj_app_.Main == "object" &&
          typeof obj_app_.Main.Setting == "object" &&
          typeof obj_app_.Main.Setting.Set_ComputerName == "function"
        ) {
      ...
      /* Main.About */
      if (typeof obj_app.Main.About == "undefined") {
        obj_app.Main.About = {};
      }
      obj_app.Main.About.Get_Version = function() {
        if (
          typeof obj_app_ == "object" &&
          typeof obj_app_.Main == "object" &&
          typeof obj_app_.Main.About == "object" &&
          typeof obj_app_.Main.About.Get_Version == "function"
        ) {

(function() {
  ...
  if (typeof obj.url == "undefined") {
    ...
    obj.url = {
      login: local_android_asset + "/html/client/login/index.html?", //登录界面
      main: local_android_asset + "/html/client/main/index.html?", //控制中心
      mainComputer: local_android_asset + "/html/client/mainComputer/index.html?", //电脑管理
      mainConsole: local_android_asset + "/html/client/mainConsole/index.html?", //电脑管理控制台
